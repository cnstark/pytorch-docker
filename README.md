...
| 1.7.0 | 3.8.12 | ![CUDA10.2] | ![Ubuntu18.04] | [![](https://img.shields.io/github/workflow/status/cnstark/pytorch_docker/Build%20Docker%20Image%20CI%20(1.7.0_py3.8.12_cuda10.2_ubuntu18.04)?logo=docker)][DockerHub] | `docker pull yuhaow/pytorch:1.7.0-py3.8.12-cuda10.2-ubuntu18.04` |
