...
| ![pytorch1.10.1]  ![python3.9.12]   ![cuda11.1]         ![ubuntu20.04]    [![](https://img.shields.io/docker/image-size/cnstark/pytorch/1.10.1-py3.9.12-cuda11.1-ubuntu20.04)][DockerHub]           | `docker pull cnstark/pytorch:1.10.1-py3.9.12-cuda11.1-ubuntu20.04` |
| ![pytorch1.10.1]  ![python3.9.12]   ![cuda11.1-devel]   ![ubuntu20.04]    [![](https://img.shields.io/docker/image-size/cnstark/pytorch/1.10.1-py3.9.12-cuda11.1-devel-ubuntu20.04)][DockerHub]     | `docker pull cnstark/pytorch:1.10.1-py3.9.12-cuda11.1-devel-ubuntu20.04` |
...
| ![pytorch1.10.0]  ![python3.9.12]   ![cuda11.1]         ![ubuntu20.04]    [![](https://img.shields.io/docker/image-size/cnstark/pytorch/1.10.0-py3.9.12-cuda11.1-ubuntu20.04)][DockerHub]           | `docker pull cnstark/pytorch:1.10.0-py3.9.12-cuda11.1-ubuntu20.04` |
| ![pytorch1.10.0]  ![python3.9.12]   ![cuda11.1-devel]   ![ubuntu20.04]    [![](https://img.shields.io/docker/image-size/cnstark/pytorch/1.10.0-py3.9.12-cuda11.1-devel-ubuntu20.04)][DockerHub]     | `docker pull cnstark/pytorch:1.10.0-py3.9.12-cuda11.1-devel-ubuntu20.04` |
